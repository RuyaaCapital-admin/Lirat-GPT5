...
1. Go to your Supabase project: https://supabase.com/dashboard/project/lmqgafeczccqpxqvyjah
...
1. Go to https://supabase.com/dashboard/project/lmqgafeczccqpxqvyjah/sql
...
2. Visit: http://localhost:3000/api/supabase/test
...
1. **alerts** - User price/volume alerts
2. **market_data_cache** - Cached market data
3. **chat_history** - AI chat conversation history
